...
-- tags
insert into tags (tag_name) values ('노벨문학상'), ('으스스한'),  ('유쾌한'),  ('여름'),  ('겨울');


-- 회원 테스트 데이터
insert into members(login_id, login_password, member_name, nickname, phone_number, email, birth_date, latest_logined_at, joined_at, `status`, current_point, member_role, joined_from, grade_id)
values ('test', 'test', '테스트 데이터', '테스트트틋', '01012341234', 'test@nhnacademy.com', '2000-03-15', '2025-10-21 12:12:11', '2023-11-22 11:23:11', '활성', 0, 'USER', '웹', 2),
	('admin', 'admin', '관리자', '관리자', '01011111111', 'admin@nhnacademy.com', '2000-03-15', '2025-10-21 12:12:11', '2021-09-11 16:22:11', '활성', 999999, 'USER', '웹', 1);



-- contributor
INSERT INTO contributors (contributor_role, contributor_name)
VALUES ('작가', '한강'), ('엮은이', '김경식'), ('옮긴이', '김난주'), ('작가', '가브리엘 가르시아 마르케스'), ('작가', '다자이 오사무'), ('옮긴이', '홍한별');


-- publisher
INSERT INTO publishers(publisher_name)
VALUES ('민음사'), ('문학동네'), ('펭귄 클래식');


-- book
INSERT INTO books(book_name, toc, `description`, regular_price, sale_price, isbn, publish_date, is_pack, book_status, stock, publisher_id, is_deleted)
VALUES ('８월에 만나요', '1장, 2장, 3장, 4장, 5장, 6장', '결혼한 지 스물일곱 해가 된 평범한 주부 아나 막달레나 바흐는 ......', 16000, 15990, 1234567890123, '2024-11-22', 1, '판매중', 12, 1, 0);

INSERT INTO book_contributor(book_id, contributor_id) VALUES (1, 4);

INSERT INTO book_tag(book_id, tag_id) VALUES (1, 1);

INSERT INTO book_image(book_image_url, book_id) VALUES ('book_image_url_sample', 1);
...
-- orders
INSERT INTO orders(member_id, order_number, total_book_price, actual_order_price, ordered_at, order_status, delivery_sent_date, delivery_arrived_date, delivery_desired_date, receiver, post_code, receiver_address, receiver_address_detail, receiver_phone, delivery_policy_id)
VALUES (1, 251234567890, 37500, 21000, '2025-10-29 11:11:11', '대기', '2025-11-01', '2025-11-02', '2025-11-03', '최유현', 30098, '보람로 96', '2005동 201호', '01012345678', 1);

INSERT INTO orders(member_id, order_number, total_book_price, actual_order_price, ordered_at, order_status, delivery_sent_date, delivery_arrived_date, delivery_desired_date, receiver, post_code, receiver_address, receiver_address_detail, receiver_phone, delivery_policy_id)
VALUES (1, 123456789012, 50000, 40000, '2025-10-29 11:11:11', '대기', '2025-11-01', '2025-11-02', '2025-11-03', '노형우', 12345, '보람로 78', '1234동 890호', '01009876543', 1);
...
values ('review image url from minio 1', 1), ('review image url from minio 1', 2);
...
-- payments
insert into payments(payment_key, order_name, payment_method, total_amount, payment_request_at, payment_approved_at, order_id)
