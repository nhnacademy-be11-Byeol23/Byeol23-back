...
public class PublisherExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handlePublisherNotFoundException(PublisherNotFoundException e, HttpServletRequest request){
	...
	public ResponseEntity<ErrorResponse> handlePublisherAlreadyExistsException(PublisherAlreadyExistsException e, HttpServletRequest request){
		ErrorResponse error = new ErrorResponse(
