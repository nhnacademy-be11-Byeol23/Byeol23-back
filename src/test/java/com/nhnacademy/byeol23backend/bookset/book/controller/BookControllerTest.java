...
// 		assertThat(body.bookStatus()).isEqualTo("품절");
// 		assertThat(body.stock()).isEqualTo(5);
// 		assertThat(body.categories()).hasSize(2);
//
...
//
// 		// when
// 		ResponseEntity<List<BookResponse>> result = bookController.getBooks(0, 10);
//
// 		// then
// 		assertThat(result.getStatusCode()).isEqualTo(HttpStatus.OK);
// 		assertThat(result.getBody()).isNotNull();
// 		List<BookResponse> body = result.getBody();
// 		assertThat(body).hasSize(2);
// 		assertThat(body.get(0).bookId()).isEqualTo(1L);
// 		assertThat(body.get(0).bookName()).isEqualTo("도서1");
// 		assertThat(body.get(1).bookId()).isEqualTo(2L);
// 		assertThat(body.get(1).bookName()).isEqualTo("도서2");
//
// 		verify(bookService, times(1)).getBooks(any(Pageable.class));
// 	}
//
// 	@Test
// 	@DisplayName("도서 목록 조회 성공 - 기본 페이징 파라미터")
// 	void getBooks_Success_WithDefaultPaging() {
// 		// given
...
// 		// given
// 		given(bookService.getBooks(any(Pageable.class))).willReturn(new ArrayList<>());
//
// 		// when
// 		ResponseEntity<List<BookResponse>> result = bookController.getBooks(1, 20);
//
// 		// then
// 		assertThat(result.getStatusCode()).isEqualTo(HttpStatus.OK);
// 		assertThat(result.getBody()).isNotNull();
...
//
// 	@Test
// 	@DisplayName("도서 목록 조회 - Pageable 파라미터 검증")
// 	void getBooks_VerifyPageable() {
// 		// given
// 		int pageNo = 2;
// 		int pageSize = 5;
// 		given(bookService.getBooks(any(Pageable.class))).willReturn(new ArrayList<>());
//
// 		// when
// 		bookController.getBooks(pageNo, pageSize);
//
// 		// then
// 		verify(bookService, times(1)).getBooks(argThat(pageable -> {
// 			PageRequest pageRequest = (PageRequest)pageable;
// 			return pageRequest.getPageNumber() == pageNo && pageRequest.getPageSize() == pageSize;
// 		}));
// 	}
// }