...
class CategoryRepositoryTest {
	...
	void updateCategoryPathName() {
		...
		r1c1c1.updatePath(r1c1.getPathId() + "/" + r1c1c1.getCategoryId(),
			r1c1.getPathName() + "/" + r1c1c1.getCategoryName());

		categoryRepository.updateSubPathNames(r1c1.getPathId(), r1c1.getPathName(),
			r1c1.getParent().getPathName() + "/" + "테크");

		Category findr1c1 = categoryRepository.findById(r1c1.getCategoryId())
			.orElseThrow(() -> new CategoryNotFoundException("카테고리를 찾을 수 없습니다."));
		Category findr1c1c1 = categoryRepository.findById(r1c1c1.getCategoryId())
			.orElseThrow(() -> new CategoryNotFoundException("카테고리를 찾을 수 없습니다."));
